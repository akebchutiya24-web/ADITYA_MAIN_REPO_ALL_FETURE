...
# (Pehle yahan START_IMAGE_URL bhi try hoti thi, lekin Google Drive ka link
# Telegram khud fetch nahi kar paata (WEBPAGE_CURL_FAILED) — isliye hata
# diya gaya; start message ab hamesha plain text hi jaata hai, jo pehle
# reliably kaam kar raha tha.)
